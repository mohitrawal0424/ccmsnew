...
<div class="flex justify-center items-center h-screen">
  <div class="flex flex-col">
    ...
    <a href="./dashboardproduct.php"><button class="text-white bg-cyan-600 p-4 m-4 rounded-lg font-semibold border border-black w-full">Campa Cola Product Panel</button></a>
