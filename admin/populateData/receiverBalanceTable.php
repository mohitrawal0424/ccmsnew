...
<div class="overflow-x-auto border-2 border-black">
                <table id="managerBlanceTable" class="w-full text-sm text-left text-gray-500">
                    <thead class="text-xs text-gray-900 uppercase bg-gray-100 border-b border-gray-500">
                      <tr class="text-white bg-blue-400 text-center text-xl border-2 border-gray-800">
                        ...
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-3 border border-gray-500">Gaadi Date</th>
                    ...
                    <tbody>
                      ...
                      $sql = "SELECT g.id as gaadi_id,g.timestamp as gaadiDate,g.expanse,g.totalbill as totalBill, g.discount,
                        ...
                        if($stmt->execute()){
                          ...
                          $i = 1;
                            while ($row = $results->fetch_assoc()) { 
                              ...
                              $availableBalanceToManger = $row["cashBalance"] - $row['expanse'] - $row['discount'] - $row['onlinePayments'] - $transferedAmount;
                              ...
                              <td scope="row" class="px-4 py-3 text-gray-600 whitespace-nowrap border"><?php echo $row["gaadiDate"]; ?></td>  
