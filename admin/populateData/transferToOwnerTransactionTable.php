                      ...
                      if ($stmt) {
                          if ($stmt->execute()) {
                              ...
                              while ($row = $result->fetch_assoc()) { 
                                $mode = $row['mode']==1 ? "Cash" : "Bank Transfer/UPI";
                                ?>
                      
                              <tr class="border">
                              <td scope="row" class="px-4 py-3 text-gray-600 whitespace-nowrap border"><?php echo $i++; ?> </td>
                              <td scope="row" class="px-4 py-3 text-gray-600 whitespace-nowrap border"><?php echo getUserName($row['senderid']); ?> </td>
                              <td scope="row" class="px-4 py-3 text-gray-600 whitespace-nowrap border"><?php echo $row['amount']; ?></td>
                              <td scope="row" class="px-4 py-3 text-gray-600 whitespace-nowrap border"><?php echo $mode; ?></td>
