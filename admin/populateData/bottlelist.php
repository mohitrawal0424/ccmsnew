...
<div class="overflow-x-auto border-2 border-black">
                <table id="bottlelisttable" class="w-full text-sm text-left text-gray-500">
                    <thead class="text-xs text-gray-900 uppercase bg-gray-100 border-b border-gray-500">
                      <tr class="text-white bg-blue-400 text-center text-xl border-2 border-gray-800">
                        <th colspan="7" class="p-4">Bottle List</th>
                      </tr>
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-3 border border-gray-500">Size</th>
                        ...
                        if($stmt->execute()){
                          ...
                          $i = 1;
                            while ($row = $results->fetch_assoc()) { 
                              ...
                              <td scope="row" class="px-4 py-3 text-gray-600 whitespace-nowrap border"><?php echo convertToLitre($row["size"]) ?></td>
                              ...
                              <td class="px-4 py-3 border">
                                <a href="./products.php?product=1&bottleid=<?php echo $row["id"]; ?>" value="<?php echo $row["id"] ?>" class="text-white bg-blue-700 rounded-lg p-1 px-4">Edit</a>
                                <a href="./products.php?product=1&bottleid=<?php echo $row["id"]; ?>" value="<?php echo $row["id"] ?>" class="text-white bg-red-700 rounded-lg p-1 px-4 bottledeleteclass">Delete</a>
                              </td>
                              </tr>            
