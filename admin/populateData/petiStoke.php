    ...
    <table id="petistoketable" class="w-full text-sm text-left text-gray-500">
      <thead class="text-xs text-gray-900 uppercase bg-gray-100 border-b border-gray-500">
        <tr class="text-white bg-blue-400 text-center text-xl border-2 border-gray-800">
          <th colspan="6" class="p-4">पेटी Stoke Table</th>
        </tr>
        <tr>
      ...
      <tbody>
        ...
        $sql = "SELECT
                      ...
                      p.bottleNos, pr.name,pr.size,p.id as petiID FROM `stokes` as s
            ...
            if ($results->num_rows > 0) {
              while ($row = $results->fetch_assoc()) { ?>
                ...
                <tr class="border">
                  ...
                  <a href="#" data-stokeType="1" value="<?php echo $row["petiID"] ?>" class="text-white bg-blue-700 rounded-lg p-1 px-4 addstokeClass">Add</a>
                  <a href="#" data-stokeType="2" value="<?php echo $row["petiID"] ?>" class="text-white bg-orange-700 rounded-lg p-1 px-4 removestokeClass">Remove</a>
                </td>
                </tr>
