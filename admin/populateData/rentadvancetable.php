...
<div class="overflow-x-auto border-2 border-black">
                <table id="rentadvancetable" class="w-full text-sm text-left text-gray-500">
                    <thead class="text-xs text-gray-900 uppercase bg-gray-100 border-b border-gray-500">
                      <tr class="text-white bg-blue-400 text-center text-xl border-2 border-gray-800">
                        <th colspan="9" class="p-4">Advance Table</th>
                      </tr>
                        <tr>
                    ...
                    <tbody>
                      <?php
                      $sql = "SELECT ra.*,rpo.name as ownername FROM `rentadvance` as ra
                      JOIN rentpropertyowner as rpo ON ra.ownerid = rpo.id";
                          ...
                          $i = 1;
                            ...
                            <td scope="row" class="px-4 py-3 text-gray-600 whitespace-nowrap border"><?php
                              ...
                              <td class="px-4 py-3 border">
                                <a href="?addadvance=1&advanceEditId=<?php echo $row["id"]; ?>" value="<?php echo $row["id"] ?>" class="text-white bg-blue-700 rounded-lg p-1 px-4">Edit</a>
                                <a href="./delete.php?deleteadvance=<?php echo $row["id"]; ?>" value="<?php echo $row["id"] ?>" class="text-white bg-orange-700 rounded-lg p-1 px-4">Delete</a>
                              </td>
                              </tr>            
