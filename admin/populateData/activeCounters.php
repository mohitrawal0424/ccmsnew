...
<div class="overflow-x-auto border-2 border-black">
                <table id="activeCounterTable" class="w-full text-sm text-left text-gray-500">
                    <thead class="text-xs text-gray-900 uppercase bg-gray-100 border-b border-gray-500">
                      <tr class="text-white bg-blue-400 text-center text-xl border-2 border-gray-800">
                        <th colspan="9" class="p-4">Active Counter</th>
                      </tr>
                        <tr>
                    ...
                    <tbody>
                      ...
                      $sql = "SELECT c.*,c.customerName as cusName FROM `counter` as c WHERE c.isClosed = 0
                          ...
                          $i = 1;
                            ...
                            <td scope="row" class="px-4 py-3 text-gray-600 whitespace-nowrap border"><?php
                              echo $newDate = date("d-M-Y", strtotime($row["date"]));  
                               ...
                               <td scope="row" class="px-4 py-3 text-gray-600 whitespace-nowrap border"><?php echo ($row["totalbill"] - $row['amountpaid'] - $row['discount']) ?></td>
                              <td class="px-4 py-3 border">
                                ...
                                <a href="./queries.php?closecounterid=<?php echo $row["id"]; ?>" value="<?php echo $row["id"] ?>" class="text-white bg-orange-700 rounded-lg p-1 px-4">Close</a>
                              </td>
                              </tr>            
