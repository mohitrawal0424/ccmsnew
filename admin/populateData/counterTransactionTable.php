<!-- Counter Transaction Table -->
<div class="overflow-x-auto border-2 border-black">
                <table id="sendToOwnerCounterTransaction" class="w-full text-sm text-left text-gray-500">
                    <thead class="text-xs text-gray-900 uppercase bg-gray-100 border-b border-gray-500">
                      <tr class="text-white bg-blue-400 text-center text-xl border-2 border-gray-800">
                        <th colspan="7" class="p-4">Counter Transaction</th>
                      </tr>
                        <tr>
                    ...
                    <tbody>
                      ...
                      $sql = "SELECT * FROM `transfertoownercounter` as ttoc
                      JOIN user ON ttoc.senderid = user.id
                      ORDER BY ttoc.timestamp DESC;";
                      ...
                      if ($stmt) {
                          if ($stmt->execute()) {
                              ...
                              <td scope="row" class="px-4 py-3 text-gray-600 whitespace-nowrap border"><?php echo $row['counter']; ?></td>
